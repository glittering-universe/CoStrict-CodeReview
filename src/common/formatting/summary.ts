...
export const FORMATTING = {
  ...
  SEPARATOR: '\n\n---\n\n',
  SIGN_OFF:
    '### Review powered by [CoStrict 🛡️](https://github.com/mattzcarey/costrict) - The open source, extensible review agent.',
  CTA: `<details>
<summary>🚀 Good review?</summary>

---

**Help us improve!** Your feedback and support make CoStrict better for everyone.

⭐ **Quick win?** [Star the repo](https://github.com/mattzcarey/costrict) if you find it useful
💡 **Have ideas?** [Open a discussion](https://github.com/mattzcarey/costrict/discussions)
...
👉 [YOUR COMPANY HERE](https://sustain.dev/sponsor/costrict) 👈
